...
class Example < JFrame
	require "clipboard"
	require_relative "../lib/ProcessadorDePendencias"
    ...
    def initUI
		...
		bttnFont = Font.new("Sans Serif", Font::PLAIN, 16)
		...
		self.openFileButton.setFont bttnFont
		...
		self.copyFileButton.setFont bttnFont
